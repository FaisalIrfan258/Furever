      ...
      <div className="mb-12 sm:mb-16 md:mb-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 items-center">
          {[
            {
              name: "Paws Rescue",
              logo: "https://images.unsplash.com/photo-1602934585418-f588bea4215c?q=80&w=200"
            },
            {
              name: "Animal Haven",
              logo: "https://images.unsplash.com/photo-1585829365295-ab7cd400c167?q=80&w=200"
            },
            {
              name: "Pet Protection League",
              logo: "https://images.unsplash.com/photo-1605001011156-cbf0b0f67a51?q=80&w=200"
            },
            {
              name: "Second Chance Shelters",
              logo: "https://images.unsplash.com/photo-1553481187-be93c21490a9?q=80&w=200"
            }
          ].map((partner, index) => (
      ...
      <div className="mb-12 sm:mb-16 md:mb-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4">
          {[
            ...
            "https://images.unsplash.com/photo-1544568100-847a948585b9?q=80&w=300", 
